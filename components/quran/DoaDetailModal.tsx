                ...
                >
                    ...
                    <div className="relative p-6 md:p-10 pb-4 md:pb-6 border-b border-white/[0.03] overflow-hidden shrink-0 bg-surface-container-lowest/40 backdrop-blur-md z-20">
                        ...
                        <div className="relative z-10 space-y-4">
                            ...
                            <h2 className="text-xl md:text-3xl font-headline font-black text-on-surface tracking-tight leading-tight">
                                {doa.nama}
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="overflow-y-auto p-6 md:p-10 space-y-10 scrollbar-hide flex-1 pb-20 md:pb-10">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-surface-container-high/40 p-6 md:p-8 rounded-[2.5rem] border border-white/[0.02]">
                                <p className="text-2xl md:text-4xl font-arabic text-right leading-[2.2] text-on-surface" dir="rtl">
                                    {doa.ar}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8 pt-6 border-t border-white/[0.03]">
                            <div className="space-y-4">
                                ...
                                <p className="text-base md:text-lg italic text-on-surface/80 leading-relaxed font-body pl-2 border-l-2 border-primary/20">
                                    {doa.tr}
                                </p>
                            </div>
                            <div className="space-y-4">
                        ...
                        {doa.tentang && (
                            <div className="space-y-6 pt-6 border-t border-white/[0.03]">
                                ...
                                <div className="bg-primary/[0.02] p-6 md:p-8 rounded-[2rem] border border-primary/5">
                                    <p className="text-sm md:text-base text-on-surface/60 leading-relaxed font-body whitespace-pre-line decoration-primary/20">
                                        {doa.tentang}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="pt-8 border-t border-white/[0.03] flex justify-center">
                            <p className="text-[8px] md:text-[10px] font-headline font-black uppercase tracking-[0.4em] text-on-surface/20">
...
export function DoaDetailModal({ doaId, open, onOpenChange }: DoaDetailModalProps) {
    ...
    if (isMobile) {
        return (
            <Drawer open={open} onOpenChange={onOpenChange}>
                <DrawerContent className="bg-surface-container-lowest/95 backdrop-blur-3xl border-white/5 p-0 h-[85vh] text-white">
                    <div className="flex-1 overflow-hidden flex flex-col">
                        ...
                        <div className="p-4 pt-0 shrink-0">
                            <Button
                                ...
                                className="w-full h-12 rounded-2xl bg-white/5 border border-white/5 text-[10px] font-black uppercase tracking-widest text-white/40 hover:text-white"
                            >
                                Tutup Detail
                            </Button>
                        </div>
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent
                className="max-w-4xl w-[95vw] max-h-[90vh] p-0 bg-surface-container-lowest/95 backdrop-blur-3xl border-white/5 overflow-hidden flex flex-col rounded-[3.5rem] shadow-3xl scrollbar-hide"
            >
