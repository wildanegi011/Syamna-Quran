                ...
                <div className="relative z-10 flex flex-col justify-between w-full h-full">
                    ...
                    <div className="flex justify-between items-center w-full">
                        <div className="flex items-center gap-4 min-w-0">
                            ...
                            <div
                                className={cn(
                                    "w-[40px] h-[40px] md:w-[48px] md:h-[48px] text-xl md:text-xl rounded-xl md:rounded-2xl flex items-center justify-center font-black shadow-xl shrink-0 relative transition-all duration-300 group-hover:rotate-3",
                            ...
                            <div className="flex flex-col min-w-0">
                                <h3
                                    className={cn(
                                        "text-lg md:text-xl font-bold tracking-tight leading-tight transition-colors truncate",
                                        isCurrentlyPlaying ? "text-primary" : "text-white group-hover:text-primary"
                                    )}
                                >
                                    {surah.namaLatin}
                                </h3>
                                <p className="text-xs md:text-xs font-medium text-white/50 italic truncate max-w-[100px] sm:max-w-[140px] mt-0.5">
                                    {surah.arti}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="text-right">
                            <span
                                className="text-3xl sm:text-4xl font-arabic transition-all duration-500 block group-hover:scale-105 origin-right tracking-wider"
                                style={{ 
