        ...
        <DrawerContent className="h-full bg-surface-container-highest border-white/10 rounded-none">
          ...
          <div className="px-4 py-6 overflow-y-auto min-h-[300px] flex-1">
            {isLoading ? (
              ...
              <div
                className="text-lg leading-[1.8] text-white/90 font-body space-y-6 pb-10 quran-info-content"
        ...
        <ScrollArea className="max-h-[60vh] min-h-[300px]">
          <div className="p-10">
            {isLoading ? (
              ...
              <div
                className="text-lg leading-[1.8] text-white/80 font-body space-y-6 quran-info-content"
