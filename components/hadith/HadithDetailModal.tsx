...
export function HadithDetailModal({ hadithId, open, onOpenChange }: HadithDetailModalProps) {
                ...
                >
                    ...
                    <div className="relative p-6 md:p-10 pb-4 md:pb-6 border-b border-white/[0.03] overflow-hidden shrink-0 bg-surface-container-lowest/40 backdrop-blur-md z-20">
                        ...
                        <div className="relative z-10 space-y-4">
                            ...
                            <h2 className="text-xl md:text-3xl font-headline font-black text-on-surface leading-tight">
                                {hadith.title}
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="overflow-y-auto p-6 md:p-10 space-y-10 scrollbar-hide flex-1 pb-20 md:pb-10">
                        ...
                        <section className="relative space-y-6">
                            ...
                            <div className="bg-surface-container-high/40 p-6 md:p-8 rounded-[2.5rem] border border-white/[0.02]">
                                <p className="text-2xl md:text-4xl font-arabic text-on-surface leading-[2.2] text-right dir-rtl">
                                    {hadith.hadeeth_ar}
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="space-y-6">
                            ...
                            <div className="prose prose-invert max-w-none">
                                <p className="text-base md:text-xl text-on-surface/80 font-body leading-relaxed whitespace-pre-line">
                                    {hadith.hadeeth}
                                </p>
                            </div>
                        </section>
                        ...
                        {hadith.explanation && (
                            <section className="space-y-6 pt-6 border-t border-white/[0.03]">
                                ...
                                <div className="bg-primary/[0.02] p-6 md:p-8 rounded-[2rem] border border-primary/5">
                                    <p className="text-sm md:text-base text-on-surface/60 font-body leading-relaxed whitespace-pre-line">
                                        {hadith.explanation}
                                    </p>
                                </div>
                            </section>
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl w-[95vw] max-h-[90vh] overflow-hidden bg-surface-container-lowest/95 backdrop-blur-3xl border-white/5 p-0 rounded-[3.5rem] shadow-3xl scrollbar-hide flex flex-col">
