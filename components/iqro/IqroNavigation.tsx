...
export function IqroNavigation({
    ...
    return (
        <footer className="fixed bottom-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-2xl border-t border-white/20 dark:border-white/10 pb-safe">
            <div className="max-w-5xl mx-auto px-4 py-4 md:px-8 md:py-6 flex items-center justify-between gap-4">
                <Button
                    variant="ghost"
                    size="lg"
                    className="rounded-2xl h-12 w-12 md:h-16 md:w-16 bg-muted/50 hover:bg-muted transition-all group border border-transparent hover:border-white/20"
                ...
                <div className="hidden sm:flex items-center gap-2 bg-muted/30 px-4 py-2 rounded-xl border border-white/5">
